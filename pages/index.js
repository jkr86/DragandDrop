...
const index = () => {
  ...
  const onDragEnd = result => {
    ...
    if(destination){
      ...
      const srcColumn = data.columns.find(
        item => item.id === srcId
      );
      const desColumn = data.columns.find(
        item => item.id === desId 
      );
      ...
      const placedItem = pickColumn.rows.find(
                                      ...
                                      <div className = "cardBg">
                                        <div className="cardBgFront">
                                          ...
                                          <div className="typeCateg">
                                            ...
                                            {card.type && <p className="type">{card.type}<span style={card.bulletStyle}>&#8226;</span></p>}
                                          </div>
                                          <h3>{card.title}</h3>
